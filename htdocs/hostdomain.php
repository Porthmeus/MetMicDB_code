...
<a class="button" href="downloadmetadata.php">Download all metadata as .csv file</a><br>
<a class="button" href="downloadgenus.php">Download all abundances as .csv file</a><br>
<div class="content">
<?php
...
$all_domain = $db->query("SELECT DISTINCT Domain FROM host_taxonomy ORDER BY Domain ASC") or die($db->error);
...
if (mysqli_num_rows($all_domain) !== 0) {
    ...
    while ($row = $all_domain->fetch_assoc()) {
        ...
        if ($domain !== "NA") {
            ...
            echo "<a href=\"menuhosts.php?value=$domain\">$domain</a><br>";
        }
    }
} else {
